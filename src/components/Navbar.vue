            ...
            <div class="flex flex-1 items-center justify-center md:items-stretch md:justify-start">
               ...
               <div class="md:ml-auto">
                  <div class="flex space-x-2">
                     ...
                     <RouterLink to="/jobs" class="text-white hover:bg-green-900 hover:text-white rounded-md px-3 py-2">
                        Jobs</RouterLink>
                     <RouterLink to="/jobs/add"
                        class="text-white hover:bg-green-900 hover:text-white rounded-md px-3 py-2">Add Jobs
                     </RouterLink>
                  </div>
               </div>
            </div>
